...
The carbon emissions measured in this study are one thread in a much larger and more alarming environmental story. The global infrastructure that runs software, the data centers, the transimission networks, the server farms that execure billions of lines of code every second
